...
public class LoanAda extends ArrayAdapter<LoanModel> {
    public ArrayList<LoanModel> MainList;
    public ArrayList<LoanModel> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public LoanAda(Context context, int id, ArrayList<LoanModel> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int pos = position + 1;
        holder.Name.setText(+pos + ".  " + subject.getLoan_type());
        pos++;
        holder.Phone.setText("KES" + subject.getAmount());
