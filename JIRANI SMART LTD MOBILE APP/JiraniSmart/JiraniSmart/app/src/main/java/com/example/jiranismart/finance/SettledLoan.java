...
public class SettledLoan extends AppCompatActivity {
    Appad produAda;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Cleared Loans");
        setContentView(R.layout.activity_settled_loan);
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.settled,
                response -> {
                    try {
                        AppModel subject;
                        ...
                        if (success == 1) {
                            ...
                            produAda = new Appad(SettledLoan.this, R.layout.loaner, SubjectList);
