...
public class AuctReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Auctioneer Registration");
        setContentView(R.layout.activity_auct_reg);
