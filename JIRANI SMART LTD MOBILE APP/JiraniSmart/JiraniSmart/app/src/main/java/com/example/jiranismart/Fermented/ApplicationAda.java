...
public class ApplicationAda extends ArrayAdapter<ApplicaModel> {
    public ArrayList<ApplicaModel> MainList;
    public ArrayList<ApplicaModel> SubjectListTemp;
    public ApplicationAda.SubjectDataFilter subjectDataFilter;

    public ApplicationAda(Context context, int id, ArrayList<ApplicaModel> subjectArrayList) {
    ...
    public Filter getFilter() {
        ...
        if (subjectDataFilter == null) {
            ...
            subjectDataFilter = new ApplicationAda.SubjectDataFilter();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ApplicationAda.ViewHolder holder = null;
        ...
        if (convertView == null) {
            ...
            holder = new ApplicationAda.ViewHolder();
            ...
            holder = (ApplicationAda.ViewHolder) convertView.getTag();
        }
