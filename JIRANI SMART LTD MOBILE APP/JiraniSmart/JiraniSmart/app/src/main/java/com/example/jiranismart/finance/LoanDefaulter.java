...
public class LoanDefaulter extends AppCompatActivity {
    Appad produAda;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Loan Loan Defaulter");
        setContentView(R.layout.activity_loan_defaulter);
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.defaulter,
                response -> {
                    try {
                        AppModel subject;
                        ...
                        if (success == 1) {
                            ...
                            produAda = new Appad(LoanDefaulter.this, R.layout.loaner, SubjectList);
