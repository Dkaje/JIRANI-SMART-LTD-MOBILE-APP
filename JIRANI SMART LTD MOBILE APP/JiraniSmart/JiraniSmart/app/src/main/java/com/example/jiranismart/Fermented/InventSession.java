...
public class InventSession {
    private static final String PREF_NAME = "InventSession";
    ...
    public void loginInvent(String entry, String fname, String lname, String email, String phone,
    ...
    public StaffMode getInventDetails() {
