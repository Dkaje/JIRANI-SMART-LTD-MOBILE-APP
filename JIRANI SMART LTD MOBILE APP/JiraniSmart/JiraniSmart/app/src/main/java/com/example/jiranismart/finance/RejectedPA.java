...
public class RejectedPA extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Rejected Deposits");
        setContentView(R.layout.activity_rejected_pa);
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.rejectedp,
                response -> {
                    try {
                        AliModel subject;
                        ...
                        if (success == 1) {
                            ...
                            produAda = new AliAda(RejectedPA.this, R.layout.loaner, SubjectList);
