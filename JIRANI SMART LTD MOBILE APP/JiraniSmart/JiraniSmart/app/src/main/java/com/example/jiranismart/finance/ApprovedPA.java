...
public class ApprovedPA extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Approved Deposits");
        setContentView(R.layout.activity_approved_pa);
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.approvedp,
                response -> {
                    try {
                        AliModel subject;
                        ...
                        if (success == 1) {
                            ...
                            produAda = new AliAda(ApprovedPA.this, R.layout.loaner, SubjectList);
