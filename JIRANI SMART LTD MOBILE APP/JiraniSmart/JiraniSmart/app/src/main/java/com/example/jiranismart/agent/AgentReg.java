...
public class AgentReg extends AppCompatActivity {
    EditText fname, lname, email, password, Iden;
    MaskEditText Phone;
    Spinner county;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Agent Registration");
        setContentView(R.layout.activity_agent_reg);
        ...
        btn.setOnClickListener(v -> {
            ...
            if (myName.isEmpty() || myLname.isEmpty() || myID.isEmpty() || myEmail.isEmpty() || mypas.isEmpty() || myPhon.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.ageReg,
                        response -> {
                            try {
