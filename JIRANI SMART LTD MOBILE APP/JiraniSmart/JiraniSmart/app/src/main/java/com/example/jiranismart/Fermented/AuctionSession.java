...
public class AuctionSession {
    private static final String PREF_NAME = "AuctionSession";
    ...
    public AuctionSession(Context mContext) {
        this.mContext = mContext;
        mPreferences = mContext.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        this.mEditor = mPreferences.edit();
    }

    public void loginAuction(String entry, String fname, String lname, String email, String phone,
    ...
    public StaffMode getAuctionDetails() {
