...
public class IssuedLoan extends AppCompatActivity {
    Appad produAda;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Issued Loans");
        setContentView(R.layout.activity_issued_loan);
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URls.issuedLoan,
                response -> {
                    try {
                        AppModel subject;
                        ...
                        if (success == 1) {
                            ...
                            produAda = new Appad(IssuedLoan.this, R.layout.loaner, SubjectList);
