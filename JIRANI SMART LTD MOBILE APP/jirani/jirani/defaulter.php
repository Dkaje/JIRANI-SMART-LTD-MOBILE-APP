            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Loan Defaulters</h4>
                                ...
                                <th>Status</th>
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM loan_borrow where disburse='Disbursed' and fina_status='Defaulter'";
																	...
																	while($rows=mysqli_fetch_array($query))//national_id,fname,lname,phone,email,username,county,reg_date
																		{
																					...
																					echo ' <tr>
																								<td>'.$rows['id_no'].'</td>
																								<td>'.$rows['borrow_id'].'</td>
																								<td>'.$rows['loan_id'].'</td>
																								<td>KES'.$rows['loan'].'</td>
																								<td>KES'.$rows['interest'].'</td>
																								<td>'.$rows['loan_period'].' months</td>
																								<td>KES'.$rows['expected_monthly'].'</td>
																								<td>KES'.$rows['total'].'</td>
																								<td>'.$rows['period'].' months</td>
																								<td>KES'.$rows['balance'].'</td>	
																								<td>'.$rows['fina_status'].'</td>		
																									 </tr>';
