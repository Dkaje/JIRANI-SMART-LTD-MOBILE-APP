...
{*/
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        $sql = mysqli_query($db, "update agent set status='1', comment='' where entry = '$id'");
        if (!$sql) {
            die("Connection failed: " . $db->connect_error);
        } else {
            //echo "<script>alert('Account Approved Successfully')</script>";
            echo "<script>location.href='newage.php' </script>";
        }
    }
    ...
    if (isset($_POST['rejectBtn'])) {
        ...
        $sql = mysqli_query($db, "update agent set status='2',comment='$remarks' where entry = '$id'");
        if (!$sql) {
            die("Connection failed: " . $db->connect_error);
        } else {
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">New Agents</h4>
                                ...
                                <th>Status</th>
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM agent where status=0";
