...
$sum=mysqli_fetch_assoc(mysqli_query($db,"SELECT sum(loan) as sta from application where status='Disbursed' and fina_status='Cleared'"));
    $query = "SELECT * FROM application where status='Disbursed' and fina_status='Cleared' order by reg_date asc";
