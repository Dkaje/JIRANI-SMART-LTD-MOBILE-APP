...
$id_no=$_POST["id_no"];
$sum=mysqli_fetch_assoc(mysqli_query($db,"SELECT sum(loan) as sta from application where status='Disbursed' and fina_status='Cleared' and id_no='$id_no'"));
    $query = "SELECT * FROM application where status='Disbursed' and fina_status='Cleared' and id_no='$id_no' order by reg_date asc";
