...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $sum=mysqli_fetch_assoc(mysqli_query($db,"SELECT sum(total) as sta from loaner where status='Pending'"));
     $query = "SELECT * FROM loaner where status='Pending' order by reg_date asc";
