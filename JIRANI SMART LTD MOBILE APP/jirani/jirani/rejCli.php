...
{*/
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        $sql = mysqli_query($db, "update client set status='1', comment='' where entry = '$id'");
        if (!$sql) {
            die("Connection failed: " . $db->connect_error);
        } else {
            //echo "<script>alert('Account Approved Successfully')</script>";
            echo "<script>location.href='rejCLi.php' </script>";
        }
    }
    ...
    if (isset($_POST['rejectBtn'])) {
        ...
        $sql = mysqli_query($db, "update client set status='2',comment='$remarks' where entry = '$id'");
        if (!$sql) {
            die("Connection failed: " . $db->connect_error);
        } else {
                            ...
                            <div class="card-body">
                                ...
                                <th>Status</th>
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM client where status=2";
